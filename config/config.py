...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "˹ʏᴏ ꭙ ᴍᴜsɪᴄʙᴏᴛ˼࿐")

OWNER_ID = list(map(int, getenv("OWNER_ID", "6180225412").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/jassbots/AlexaMusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/punjabiii_chat")
